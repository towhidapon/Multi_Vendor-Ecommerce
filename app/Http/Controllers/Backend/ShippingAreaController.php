...
class ShippingAreaController extends Controller
{
    public function AllDivision()
    {
        ...
        return view('admin.backend.shipping.division.division_all', compact('division'));
    } // End Method

    public function AddDivision()
    {
        return view('admin.backend.shipping.division.division_add');
    } // End Method
    ...
    public function EditDivision($id)
    {
        ...
        return view('admin.backend.shipping.division.division_edit', compact('division'));
    } // End Method
    ...
    public function AllDistrict()
    {
        ...
        return view('admin.backend.shipping.district.district_all', compact('district'));
    } // End Method

    public function AddDistrict()
    {
        $division = ShipDivision::orderBy('division_name', 'ASC')->get();
        return view('admin.backend.shipping.district.district_add', compact('division'));
    } // End Method
    ...
    public function EditDistrict($id)
    {
        ...
        return view('admin.backend.shipping.district.district_edit', compact('district', 'division'));
    } // End Method
    ...
    public function AllState()
    {
        ...
        return view('admin.backend.shipping.state.state_all', compact('state'));
    } // End Method
    ...
    public function AddState()
    {
        ...
        return view('admin.backend.shipping.state.state_add', compact('division', 'district'));
    } // End Method
    ...
    public function EditState($id)
    {
        ...
        return view('admin.backend.shipping.state.state_edit', compact('division', 'district', 'state'));
    } // End Method
