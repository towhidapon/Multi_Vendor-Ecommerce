                ...
                <div class="row">
                    ...
                    <form method="post" action="{{ route('checkout.store') }}">
                        ...
                        <div class="row shipping_calculator">
                            <div class="form-group col-lg-6">
                                <div class="custom_select">
                                    <select id="division_id" name="division_name" class="form-control">
                        ...
                        <div class="row shipping_calculator">
                            <div class="form-group col-lg-6">
                                <div class="custom_select">
                                    <select name="district_name" id="district_id" class="form-control">
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            divisionSelect.addEventListener('change', function() {
                ...
                if (divisionId) {
                    fetch(`/get-district/${divisionId}`)
                        .then(response => response.json())
                        .then(data => {
                            districtSelect.innerHTML =
                                '<option value="">Select a District</option>';
                            data.forEach(district_id => {
                                const option = document.createElement('option');
                                option.value = district_id.id;
                                option.innerText = district_id.district_name;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            districtSelect.addEventListener('change', function() {
                ...
                if (districtId) {
                    fetch(`/get-state/${districtId}`)
                        .then(response => response.json())
                        .then(data => {
                            stateSelect.innerHTML =
                                '<option value="">Select an State</option>';
                            data.forEach(state_id => {
                                const option = document.createElement('option');
                                option.value = state_id.id;
                                option.innerText = state_id.state_name;
