                            ...
                            <div class="tab-content account dashboard-content pl-50">
                                <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                    ...
                                    <div class="card">
                                        ...
                                        <br>
                                        <img src="{{ !empty($adminData->photo) ? url('admin/upload/' . $adminData->photo) : url('admin/upload/no_image.jpg') }}"
                                            ...
                                            <form method="post" action="{{ route('user.profile.store') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <img id="showImage"
                                                            src="{{ !empty($adminData->photo) ? url('admin/upload/' . $adminData->photo) : url('admin/upload/no_image.jpg') }}"
