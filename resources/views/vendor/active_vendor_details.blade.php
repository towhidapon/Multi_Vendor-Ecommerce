            ...
            <div class="container">
                ...
                {{ $activeVendorDetails->vendor_short_info }}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <img id="showImage"
                                                    src="{{ !empty($activeVendorDetails->photo) ? url('vendor/upload/' . $activeVendorDetails->photo) : url('vendor/upload/no_image.jpg') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <a href="{{ route('active.vendor.status', $activeVendorDetails->id)}}" class="btn btn-danger">Inactive</a>
                                            </div>
                                        </div>
                                </div>
