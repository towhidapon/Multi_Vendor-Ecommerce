                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ !empty($vendorData->photo) ? url('vendor/upload/' . $vendorData->photo) : url('vendor/upload/no_image.jpg') }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage"
                                        src="{{ !empty($vendorData->photo) ? url('vendor/upload/' . $vendorData->photo) : url('vendor/upload/no_image.jpg') }}"
