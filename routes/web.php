...
Route::middleware(['auth', 'role:vendor'])->group(function () {
    ...
    Route::controller(VendorProductController::class)->group(function () {
        ...
        // Route::get('/vendor/get-subcategories/{category_id}', 'VendorGetSubCategory');

        Route::get('/vendor/get-subcategories/{category_id}', 'VendorgetSubcategories');
    });
});
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::controller(SubcategoryController::class)->group(function () {
        ...
        Route::get('/get-subcategories/{category_id}', 'GetSubCategory');
    });
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::get('/active/vendor/status/{id}', 'ActiveVendorStatus')->name('active.vendor.status');
